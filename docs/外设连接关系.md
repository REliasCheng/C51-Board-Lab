...
![数码管段码总线](../assets/images/diagram/seven-segment-data-bus.png)
...
动态显示按照“关闭段码 → 选择位 → 写入段码 → 延时”的顺序轮询。模块化实现会在位切换时清空 P0，用于减轻重影。

## 数码管与点阵跳线

![J24 跳线](../assets/images/hardware/j24-display-matrix-selector.png)
...
![LED 点阵连接](../assets/images/diagram/led-matrix-wiring.png)

## AT24C02

![AT24C02 接口](../assets/images/diagram/at24c02-interface.png)

AT24C02 使用 `SCL=P2.1`、`SDA=P2.0`。软件驱动以 GPIO 模拟 I²C，包含 START、STOP、字节读写和 ACK/NACK 时序。
